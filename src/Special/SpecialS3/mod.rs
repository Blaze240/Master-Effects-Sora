...
unsafe extern "C" fn effect_specials3_fusion(agent: &mut L2CAgentBase) {
    ...
    if get_value_float(agent.lua_state_agent, *SO_VAR_FLOAT_LR) < 0.0 {
        if macros::is_excute(agent) {
            macros::EFFECT(
                agent,
                Hash40::new("cloud_kyogiri_stroke3_l"),
                Hash40::new("top"),
                0,
                11,
                17,
            ...
            macros::EFFECT(
                agent,
                Hash40::new("cloud_kyogiri_stroke4_l"),
                Hash40::new("top"),
                0,
                11,
                17,
        ...
        if macros::is_excute(agent) {
            macros::EFFECT(
                agent,
                Hash40::new("cloud_kyogiri_stroke3_r"),
                Hash40::new("top"),
                0,
                11,
                17,
            ...
            macros::EFFECT(
                agent,
                Hash40::new("cloud_kyogiri_stroke4_r"),
                Hash40::new("top"),
                0,
                11,
                17,
