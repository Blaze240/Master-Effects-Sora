...
unsafe extern "C" fn effect_specialairs2_lb_limit(agent: &mut L2CAgentBase) {
    ...
    if get_value_float(agent.lua_state_agent, *SO_VAR_FLOAT_LR) < 0.0 {
        if macros::is_excute(agent) {
            macros::EFFECT(
                agent,
                Hash40::new("cloud_kyogiri_stroke2_l_lb"),
                Hash40::new("top"),
                0,
                11,
                17,
        ...
        if macros::is_excute(agent) {
            macros::EFFECT(
                agent,
                Hash40::new("cloud_kyogiri_stroke2_r_lb"),
                Hash40::new("top"),
                0,
                11,
                17,
...
pub fn install() {
    Agent::new("cloud")
        .effect_acmd(
            "effect_specialairs2_lb",
            effect_specialairs2_lb_limit,
            Priority::Low,
        )
        .install();
}
